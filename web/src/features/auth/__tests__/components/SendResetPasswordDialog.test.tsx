...
describe('SendResetPasswordDialog', () => {
  ...
  it('renders correctly when open state is true', () => {
    ...
    expect(screen.getByRole('heading', { name: 'Réinitialisé votre mot de passe.' })).toBeInTheDocument();
    expect(screen.getByText('Recevoir un lien par mail pour la mise à jour de votre mot de passe.')).toBeInTheDocument();
