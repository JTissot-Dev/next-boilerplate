...
describe("SignInFacebook", () => {
    ...
    it("renders button", () => {
        ...
        expect(screen.getByRole("button", { name: "Se connecter avec Facebook" })).toBeInTheDocument();
    });
    ...
    it("calls signInFacebook on click", async () => {
        ...
        render(<SignInFacebook />);
        const button = screen.getByRole("button", { name: "Se connecter avec Facebook" });
    ...
    it("shows loading state when loading is true", async () => {
        ...
        render(<SignInFacebook />);
        const button = screen.getByRole("button", { name: "Redirection en cours..." });
        await waitFor(() => {
